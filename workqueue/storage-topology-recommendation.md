...
3. **Should Boris read MinIO coordination data via a periodic mirror, or is Azure-only coordination sufficient?** (He already checks the dashboard at 146.190.134.110:8788 — that covers heartbeats.)

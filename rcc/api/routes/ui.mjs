...
`;
    ...
    const envLines = [`CCC_AGENT_TOKEN=${agentToken}`, `CCC_URL=${state.RCC_PUBLIC_URL}`, `AGENT_NAME=${entry.agent}`, `AGENT_ROLE=${roleHint}`];
...
<div class="header">
  ...
  <div class="nav"><a href="/">&#8592; CCC</a><a href="/services">Services</a><a href="https://github.com/jordanhubbard/nano-packages" target="_blank">GitHub</a></div>
</div>
<div class="container">

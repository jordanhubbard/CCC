...
- **URL (canonical/public):** http://146.190.134.110:8788/
- **URL (local):** http://localhost:8788/
- **Note:** Use the public IP for all agents — Boris is a container with no Tailscale access. Tailscale IP (100.89.199.14:8788) also works but public is canonical.
...
- `http://100.89.199.14:8888/search?q={query}&format=json`
- No auth required

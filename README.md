...
Rocky Command Center lives at **http://YOUR_PUBLIC_IP:8788/**
...
- **MinIO:** Internal S3 at `http://YOUR_TAILSCALE_IP:9000`, bucket `agents/`
- **Azure Blob:** Public assets at `https://loomdd566f62.blob.core.windows.net/assets/`
- **SearXNG:** Self-hosted search at `http://YOUR_TAILSCALE_IP:8888`
